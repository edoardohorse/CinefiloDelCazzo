...
export class FilmController {
    constructor() {
        ...
        // Get film by ID
        this.getFilmById = async (req, res) => {
            try {
        ...
        this.updateFilm = async (req, res) => {
            try {
                ...
                if (updateData.name !== undefined)
                    filmUpdate.name = updateData.name;
                if (updateData.thumbnail !== undefined)
                    filmUpdate.thumbnail = updateData.thumbnail;
                if (updateData.releaseDate !== undefined)
                    filmUpdate.releaseDate = new Date(updateData.releaseDate);
                if (updateData.endDate !== undefined)
                    filmUpdate.endDate = updateData.endDate ? new Date(updateData.endDate) : null;
                if (updateData.type !== undefined)
                    filmUpdate.type = updateData.type;
                if (updateData.description !== undefined)
                    filmUpdate.description = updateData.description;
                if (updateData.links !== undefined)
                    filmUpdate.description = updateData.links;
